...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Aquinate`}</title>

        <meta
          name="description"
          content="Experience seamless task management with Aquinate, your ultimate solution for efficient IP Office operations."
        />
      </Head>
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Experience seamless task management with Aquinate, your ultimate solution for efficient IP Office operations.`}
            </Text>
        ...
        <Flex position="relative" flex={1}>
          <Image
            src={
              'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0YXNrJTIwbWFuYWdlbWVudCUyQ29mZmljZXxlbnwwfHx8fDE2ODg0MTQ3NDh8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt={'Login Image'}
            objectFit={'cover'}
          />
